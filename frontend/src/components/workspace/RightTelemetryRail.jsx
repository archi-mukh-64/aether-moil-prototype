  ...
  const telemetryRows = [
    {
      id: 'extraction',
      icon: Activity,
      iconColor: 'text-cyan-400 bg-[#122336]',
    ...
    },
    {
      id: 'haulage',
      icon: Truck,
      iconColor: 'text-amber-400 bg-[#2b1f14]',
      ...
      <div className="space-y-1.5 font-mono text-xs">
        {telemetryRows.map((row) => {
          ...
          return (
            <div
              key={row.id}
              className="p-2.5 rounded-xl bg-[#0c1017] border border-[#1a2333] hover:border-[#26354d] transition-all flex items-center justify-between gap-2 shadow-sm"
            >
